...
import io.vanguard.testops.functional.constants.CaseReviewPassRule;
...
import io.vanguard.testops.functional.mapper.CaseReviewFunctionalCaseMapper;
import io.vanguard.testops.functional.mapper.CaseReviewHistoryMapper;
...
import io.vanguard.testops.functional.request.BaseAssociateCaseRequest;
import io.vanguard.testops.functional.request.CaseReviewRequest;
...
import io.vanguard.testops.functional.utils.FileBaseUtils;
...
public class ReviewFunctionalCaseControllerTests extends BaseTest {
    ...
    public void testUploadTemp() throws Exception {
        ...
        functionalCaseAttachmentService.uploadOssFile("gyqReviewCaseTest", "project-review-case-test", List.of(fileId), "admin", CaseFileSourceType.REVIEW_COMMENT.toString());
        ...
        functionalCaseAttachmentService.uploadOssFile("gyqReviewCaseTest", "project-review-case-test", new ArrayList<>(), "admin", CaseFileSourceType.REVIEW_COMMENT.toString());
    ...
    public void downTemp() throws Exception {
        ...
        Assertions.assertTrue(compressedResult.getResponse().getContentAsByteArray().length > 0);
        functionalCaseAttachmentService.uploadOssFile("gyqReviewCaseTest", "project-review-case-test", List.of(fileId), "admin", CaseFileSourceType.CASE_DETAIL.toString());
