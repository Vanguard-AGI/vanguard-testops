...
import io.vanguard.testops.system.dto.request.OrganizationMemberBatchRequest;
import io.vanguard.testops.system.dto.request.ProjectAddMemberBatchRequest;
...
import io.vanguard.testops.system.dto.request.user.UserChangeEnableRequest;
import io.vanguard.testops.system.dto.request.user.UserEditRequest;
...
import io.vanguard.testops.system.dto.user.response.*;
...
public class UserController {
    ...
    /**
     * 获取用户列表（公开接口，用于aegis-one-web等外部系统访问，无需认证）
     */
    @GetMapping("/list/public")
    @Operation(summary = "获取用户列表（公开接口）")
    public List<UserSimpleDTO> getUserListPublic() {
        return simpleUserService.getPublicUserList();
    }
}
