...
import io.vanguard.testops.api.dto.export.ApiDefinitionExportResponse;
import io.vanguard.testops.api.mapper.ExtApiDefinitionMapper;
import io.vanguard.testops.api.mapper.ExtApiDefinitionMockMapper;
import io.vanguard.testops.api.mapper.ExtApiTestCaseMapper;
import io.vanguard.testops.api.support.parser.export.MetersphereApiDefinitionExportParser;
import io.vanguard.testops.api.support.parser.export.Swagger3ApiDefinitionExportParser;
...
public class ApiDefinitionExportService {
    ...
    private ApiDefinitionExportResponse exportSwagger(ApiDefinitionBatchRequest request, List<ApiDefinitionWithBlob> list, Map<String, String> moduleMap) {
        ...
        Swagger3ApiDefinitionExportParser swagger3Parser = new Swagger3ApiDefinitionExportParser();
        try {
    ...
    private ApiDefinitionExportResponse exportMetersphere(ApiDefinitionBatchExportRequest request, List<ApiDefinitionWithBlob> list, Map<String, String> moduleMap) {
        try {
            ...
            return new MetersphereApiDefinitionExportParser().parse(list, apiTestCaseWithBlobs, apiMockWithBlobs, moduleMap);
        } catch (Exception e) {
            throw new MSException(e);
        }
    }
