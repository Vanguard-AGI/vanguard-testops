...
public class User implements Serializable {
    ...
    @Schema(description = "飞书用户open_id")
    @Size(max = 100, message = "{user.lark_open_id.length_range}", groups = {Created.class, Updated.class})
    ...
    public enum Column {
        ...
        larkOpenId("lark_open_id", "larkOpenId", "VARCHAR", false),
