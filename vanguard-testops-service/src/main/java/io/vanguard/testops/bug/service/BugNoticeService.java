...
import io.vanguard.testops.system.dto.BugNoticeDTO;
            ...
            request.getCustomFields().forEach(field -> {
                if (StringUtils.equals(field.getId(), CUSTOM_TITLE)) {
                    ...
                    if (StringUtils.isNotBlank(field.getText())) {
                        var arr = PluginUtils.parseArray(field.getText());
                        if (!arr.isEmpty() && arr.getFirst() != null) {
                            notice.setStatus(arr.getFirst().toString());
                        }
                    }
                    ...
                    if (StringUtils.isNotBlank(field.getText())) {
                        var arr = PluginUtils.parseArray(field.getText());
                        if (!arr.isEmpty() && arr.getFirst() != null) {
                            notice.setHandleUser(arr.getFirst().toString());
                        }
                    }
                } else {
