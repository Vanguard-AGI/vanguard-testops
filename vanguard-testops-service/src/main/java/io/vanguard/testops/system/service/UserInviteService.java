...
import io.vanguard.testops.system.domain.UserInviteExample;
import io.vanguard.testops.system.mapper.UserInviteMapper;
...
public class UserInviteService {
    ...
    public String genInviteMessage(String inviteUser, String inviteId, String baseUrl) {
        ...
        return "<html>\n" +
                ...
                "                                    <thead>\n" +
                "                                    <tr style=\"background-color: #2f54eb; padding: 3px 0; line-height: 68px; text-align: center; color: #fff; font-size: 24px; font-weight: 700; letter-spacing: 1px;\">\n" +
                "                                        <th scope=\"col\"></th>\n" +
                "                                    </tr>\n" +
                "                                    </thead>\n" +
                "\n" +
                ...
                "                                            <span style=\"color:#2f54eb\">" + inviteUser + "</span>\n" +
                "                                            " + Translator.get("user.email.invite_ms") + "\n" +
                "                                        </td>\n" +
                "                                    </tr>\n" +
                "                                    <tr>\n" +
                "                                        <td style=\"padding: 7px 24px;\">\n" +
                "                                            <a style=\"background-color: #2f54eb;color:#FFFFFF;padding: 4px 10px; outline:\n" +
                "                                            none;\n" +
                ...
                "                                            <a style=\"color:#2f54eb\" href=\"" + inviteUrl + "\">" + inviteUrl + "</a>（" + Translator.get("user.email.invite_limited_time") + "）\n" +
                "                                        </td>\n" +
                "                                    </tr>\n" +
                "                                    <tr>\n" +
