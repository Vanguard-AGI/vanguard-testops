package io.vanguard.testops.system.interceptor;
...
import io.vanguard.testops.system.dto.sdk.DBCombineSearch;
...
public class BaseConditionFilterAspect {
    @Pointcut("@annotation(io.vanguard.testops.system.interceptor.BaseConditionFilter)")
