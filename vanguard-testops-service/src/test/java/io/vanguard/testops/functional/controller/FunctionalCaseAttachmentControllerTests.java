...
public class FunctionalCaseAttachmentControllerTests extends BaseTest {
    ...
    public void testUploadTemp() throws Exception {
        ...
        functionalCaseAttachmentService.uploadOssFile("TEST_FUNCTIONAL_CASE_ATTACHMENT_ID_1", "WX_TEST_PROJECT_ID", List.of(fileId), "admin", CaseFileSourceType.CASE_DETAIL.toString());
        ...
        functionalCaseAttachmentService.uploadOssFile("TEST_FUNCTIONAL_CASE_ATTACHMENT_ID_1", "WX_TEST_PROJECT_ID", new ArrayList<>(), "admin", CaseFileSourceType.CASE_COMMENT.toString());
