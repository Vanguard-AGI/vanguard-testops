...
public class ReviewFunctionalCaseService {
    ...
    public void saveReview(ReviewFunctionalCaseRequest request, String userId) {
        ...
        //保存富文本评论附件
        functionalCaseAttachmentService.uploadOssFile(caseId, request.getProjectId(), request.getReviewCommentFileIds(), userId, CaseFileSourceType.REVIEW_COMMENT.toString());
