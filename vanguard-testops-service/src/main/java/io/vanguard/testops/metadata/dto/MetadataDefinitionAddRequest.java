...
@Data
public class MetadataDefinitionAddRequest {
    ...
    @NotBlank(message = "{metadata_definition.protocol.not_blank}")
    @Size(min = 1, max = 20, message = "{metadata_definition.protocol.length_range}")
