...
import io.vanguard.testops.functional.domain.FunctionalCaseCommentExample;
...
import io.vanguard.testops.functional.mapper.FunctionalCaseCommentMapper;
...
public class FunctionalCaseCommentService {
    ...
    public FunctionalCaseComment saveCommentOrAt(FunctionalCaseCommentRequest functionalCaseCommentRequest, FunctionalCaseComment functionalCaseComment, String userId) {
        ...
        //保存文件
        functionalCaseAttachmentService.uploadOssFile(functionalCaseCommentRequest.getCaseId(),functionalCaseCommentRequest.getProjectId(),functionalCaseCommentRequest.getUploadFileIds(), userId, CaseFileSourceType.CASE_COMMENT.toString());
        //发送@ 通知人
