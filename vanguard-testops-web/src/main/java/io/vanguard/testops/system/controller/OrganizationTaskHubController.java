...
import io.vanguard.testops.system.dto.taskhub.ResourcePoolOptionsDTO;
import io.vanguard.testops.system.dto.taskhub.TaskHubDTO;
import io.vanguard.testops.system.dto.taskhub.TaskHubItemDTO;
import io.vanguard.testops.system.dto.taskhub.TaskHubScheduleDTO;
...
import io.vanguard.testops.system.service.BaseTaskHubLogService;
...
public class OrganizationTaskHubController {
    ...
    public Pager<List<TaskHubScheduleDTO>> scheduleList(@Validated @RequestBody BasePageRequest request) {
        return baseTaskHubService.getScheduleTaskList(request, getOrganizationProjectIds());
    }
    ...
    public void batchEnable(@Validated @RequestBody TableBatchProcessDTO request) {
        List<String> projectIds = getOrganizationProjectIds();
    ...
    private List<String> getOrganizationProjectIds() {
        return systemProjectService.getProjectOptions(SessionUtils.getCurrentOrganizationId())
                .stream()
                .map(OrganizationProjectOptionsDTO::getId)
                .toList();
    }
}
