...
import io.vanguard.testops.api.controller.param.ApiTestCaseAddRequestDefinition;
...
import io.vanguard.testops.api.service.definition.ApiTestCaseNoticeService;
...
public class ApiTestCaseControllerTests extends BaseTest {
    ...
    public void delete() throws Exception {
        ...
        List<String> fileNames = ossRepository.getFolderFileNames(request);
        //校验文件
