...
import io.vanguard.testops.api.dto.report.ApiReportListDTO;
...
import io.vanguard.testops.sdk.dto.api.result.RequestResult;
...
public class ApiReportService {
    ...
    public ApiReportDTO get(String id) {
        ...
        apiReportDTO.setEnvironmentName(resolveEnvironmentName(apiReportDTO.getEnvironmentId()));
        apiReportDTO.setCreatUserName(resolveUserName(apiReportDTO.getCreateUser()));
        //需要查询出所有的步骤
    ...
    private void setEnvironment(String reportId, ApiTaskReportDTO apiTaskReportDTO) {
        ...
        String environmentName = resolveEnvironmentName(apiReport.getEnvironmentId());
        apiTaskReportDTO.setEnvironmentName(environmentName);
    }
