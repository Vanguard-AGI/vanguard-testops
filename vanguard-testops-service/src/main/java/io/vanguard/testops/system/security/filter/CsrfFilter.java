...
import io.vanguard.testops.system.security.handler.ApiKeyHandler;
...
public class CsrfFilter extends AnonymousFilter {
    ...
    protected boolean onPreHandle(ServletRequest request, ServletResponse response, Object mappedValue) {
        ...
        if ("/lark/user".equals(requestURI) || "/lark/info".equals(requestURI) || "/lark/login".equals(requestURI)) {
            return true;
        }
