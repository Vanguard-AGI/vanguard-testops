...
import io.vanguard.testops.system.base.param.InvalidateParamInfo;
import io.vanguard.testops.system.base.param.ParamGeneratorFactory;
...
public abstract class BaseTest {
    ...
    public void login() throws Exception {
        ...
        // 初始化MinIO配置
        ((OssRepository) FileCenter.getRepository(StorageType.MINIO)).init(client);
