package io.vanguard.testops.project.domain;
...
public class MessageTaskExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addReceiversCriterion(String condition, Object value, String property) {
            ...
            receiversCriteria.add(new Criterion(condition, value, "io.vanguard.testops.handler.ListTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addReceiversCriterion(String condition, List<String> value1, List<String> value2, String property) {
            ...
            receiversCriteria.add(new Criterion(condition, value1, value2, "io.vanguard.testops.handler.ListTypeHandler"));
            allCriteria = null;
        }
