...
import io.vanguard.testops.project.api.assertion.body.Condition;
import io.vanguard.testops.project.api.assertion.body.ElementCondition;
import io.vanguard.testops.project.api.assertion.body.MsDocumentAssertion;
import io.vanguard.testops.project.api.assertion.body.MsDocumentAssertionElement;
...
public class DocumentAssertionConverter extends ResponseBodyTypeAssertionConverter<MsDocumentAssertion> {
    ...
    private <T extends TestElement> T newAssertion(MsDocumentAssertionElement item, ElementCondition elementCondition, boolean globalEnable, T assertion) {
        ...
        if (assertion instanceof XMLAssertion) {
            XMLAssertion xmlAssertion = (XMLAssertion) assertion;
