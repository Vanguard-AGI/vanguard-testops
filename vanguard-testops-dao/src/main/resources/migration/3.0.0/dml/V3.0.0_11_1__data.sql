...
VALUES ('admin', 'Administrator', 'admin@metersphere.io', 'ef1d102434fa5f616eb617ed84793774', UNIX_TIMESTAMP() * 1000, UNIX_TIMESTAMP() * 1000, NULL, NUll, '', 'LOCAL', NULL, 'admin', 'admin',false);
