...
import io.vanguard.testops.project.mapper.*;
...
import io.vanguard.testops.sdk.dto.FileMetadataRepositoryDTO;
import io.vanguard.testops.sdk.dto.FileModuleRepositoryDTO;
...
public class FileManagementService {
    ...
    public byte[] getPreviewImg(FileMetadata fileMetadata) {
        ...
        previewRequest.setStorage(StorageType.OSS.name());
