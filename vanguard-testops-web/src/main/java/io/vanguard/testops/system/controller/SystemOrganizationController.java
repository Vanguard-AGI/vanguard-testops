...
import io.vanguard.testops.system.service.SystemOrganizationLogService;
...
public class SystemOrganizationController {
    ...
    public OrganizationDTO add(@Validated @RequestBody OrganizationEditRequest organizationEditRequest) {
