...
@Data
public class WorkflowEngineProfileUpdateRequest {

    @Schema(description = "配置ID", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlank(message = "{workflow_engine_profile.id.not_blank}")
    @Size(min = 1, max = 50, message = "{workflow_engine_profile.id.length_range}")
    private String id;
