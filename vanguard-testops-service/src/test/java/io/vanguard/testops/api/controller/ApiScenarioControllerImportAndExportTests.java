...
public class ApiScenarioControllerImportAndExportTests extends BaseTest {
    ...
    public void testImport() throws Exception {
        ...
        inputStream = new FileInputStream(Objects.requireNonNull(this.getClass().getClassLoader().getResource("file/import-scenario/vanguard/testops/simple.ms")).getPath());
