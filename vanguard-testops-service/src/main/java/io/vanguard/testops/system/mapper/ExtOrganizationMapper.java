...
import io.vanguard.testops.system.dto.request.OrganizationDeleteRequest;
import io.vanguard.testops.system.dto.request.OrganizationRequest;
...
public interface ExtOrganizationMapper {
     ...
     * @return 最大编号的组织
     */
    Organization getMaxNumOrganization();
}
