...
import io.vanguard.testops.plan.constants.CollectionQueryType;
...
import io.vanguard.testops.plan.enums.TestPlanReportAttachmentSourceType;
import io.vanguard.testops.plan.mapper.*;
import io.vanguard.testops.plan.support.report.CountUtils;
...
import io.vanguard.testops.system.support.metrics.RateCalculateUtils;
...
public class TestPlanReportService {
    ...
    public TestPlanReportDetailResponse getReport(String reportId) {
        ...
        planReportDetail.setFunctionalBugCount(bugSumMap.getOrDefault(CaseType.FUNCTIONAL_CASE.getKey(), 0L).intValue());
        planReportDetail.setApiBugCount(bugSumMap.getOrDefault(CaseType.API_CASE.getKey(), 0L).intValue());
        planReportDetail.setScenarioBugCount(bugSumMap.getOrDefault(CaseType.SCENARIO_CASE.getKey(), 0L).intValue());
