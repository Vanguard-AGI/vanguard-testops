...
import io.vanguard.testops.api.constants.*;
import io.vanguard.testops.api.domain.*;
import io.vanguard.testops.api.dto.ApiFile;
import io.vanguard.testops.api.dto.ApiScenarioParamConfig;
import io.vanguard.testops.api.dto.ApiScenarioParseTmpParam;
...
import io.vanguard.testops.api.dto.converter.ApiScenarioPreImportAnalysisResult;
import io.vanguard.testops.api.dto.debug.ApiFileResourceUpdateRequest;
import io.vanguard.testops.api.dto.debug.ApiResourceRunRequest;
import io.vanguard.testops.api.dto.definition.*;
import io.vanguard.testops.api.dto.export.ApiScenarioExportResponse;
import io.vanguard.testops.api.dto.export.JMeterApiScenarioExportResponse;
import io.vanguard.testops.api.dto.export.MetersphereApiScenarioExportResponse;
import io.vanguard.testops.api.dto.request.MsScenario;
import io.vanguard.testops.api.dto.scenario.*;
import io.vanguard.testops.api.mapper.*;
import io.vanguard.testops.api.support.parser.ApiScenarioImportParser;
import io.vanguard.testops.api.support.parser.factory.ImportParserFactory;
import io.vanguard.testops.api.service.definition.ApiDefinitionExportService;
import io.vanguard.testops.api.service.definition.ApiDefinitionImportService;
import io.vanguard.testops.api.service.definition.ApiDefinitionModuleService;
import io.vanguard.testops.api.service.definition.ApiTestCaseService;
import io.vanguard.testops.api.service.scenario.*;
import io.vanguard.testops.api.support.data.ApiDataUtils;
import io.vanguard.testops.api.support.parser.dataimport.ApiDefinitionImportUtils;
import io.vanguard.testops.api.support.parser.dataimport.ApiScenarioImportUtils;
...
import io.vanguard.testops.project.dto.filemanagement.FileAssociationSource;
import io.vanguard.testops.project.mapper.ExtBaseProjectVersionMapper;
import io.vanguard.testops.project.mapper.ExtFileAssociationMapper;
import io.vanguard.testops.project.mapper.ProjectMapper;
import io.vanguard.testops.system.service.PermissionCheckService;
import io.vanguard.testops.project.support.file.FileDownloadUtils;
...
import io.vanguard.testops.system.support.tree.TreeNodeParseUtils;
...
import static io.vanguard.testops.project.support.sort.NodeSortUtils.DEFAULT_NODE_INTERVAL_POS;
...
public class ApiScenarioDataTransferService {
    ...
    private String exportApiScenarioZip(ApiScenarioBatchExportRequest request, String exportType, String userId) throws Exception {
        ...
        try {
            ...
            fileService.upload(zipFile, new FileRequest(DefaultRepositoryDir.getExportApiTempDir(), StorageType.OSS.name(), request.getFileId()));
