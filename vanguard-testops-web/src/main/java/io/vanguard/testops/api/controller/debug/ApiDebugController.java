package io.vanguard.testops.api.controller.debug;

import io.vanguard.testops.api.support.curl.domain.CurlEntity;
import io.vanguard.testops.api.support.curl.parser.CurlParser;
...
import io.vanguard.testops.api.service.debug.ApiDebugLogService;
...
public class ApiDebugController {
    ...
    public CurlEntity importCurl(@RequestBody ApiImportCurlRequest request) {
        CurlEntity parse = CurlParser.parse(request.getCurl());
