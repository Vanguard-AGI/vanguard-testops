package io.vanguard.testops.project.controller.filemanagement;

import io.vanguard.testops.project.domain.*;
import io.vanguard.testops.project.dto.ModuleCountDTO;
import io.vanguard.testops.project.dto.filemanagement.FileAssociationDTO;
...
import io.vanguard.testops.project.dto.filemanagement.response.FileAssociationResponse;
...
import io.vanguard.testops.project.mapper.FileModuleMapper;
...
import io.vanguard.testops.project.utils.FileManagementBaseUtils;
import io.vanguard.testops.project.utils.FileManagementRequestUtils;
...
import io.vanguard.testops.sdk.util.TempFileUtils;
...
public class FileManagementControllerTests extends BaseTest {
    ...
    public void fileReUploadTestSuccess() throws Exception {
        ...
        //测试完了改回去
        updateModel.setStorage(StorageType.OSS.name());
        fileMetadataMapper.updateByPrimaryKeySelective(updateModel);
...
//                .andExpect(status().is5xxServerError());
    ...
    public void fileBatchDownload() throws Exception {
        ...
        for (int i = 0; i < 20; i++) {
            ...
            fileMetadata.setStorage(StorageType.OSS.name());
