...
import io.vanguard.testops.api.support.parser.jmeter.xstream.MsSaveService;
...
public class JmeterApiDefinitionImportParser implements ApiDefinitionImportParser<ApiDefinitionImportFileParseResult> {
    ...
    private LinkedHashMap<ApiDefinitionDetail, List<ApiTestCaseDTO>> parseImportFile(String projectId, List<AbstractMsProtocolTestElement> msElement) {
        ...
        for (AbstractMsProtocolTestElement protocolTestElement : msElement) {
            ...
            if (protocolTestElement instanceof MsHTTPElement) {
                MsHTTPElement msHTTPElement = (MsHTTPElement) protocolTestElement;
