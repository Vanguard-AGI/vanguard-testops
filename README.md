...
Vanguard-TestOps 是新一代的开源持续测试工具，让软件测试工作更简单、更高效，不再成为持续交付的瓶颈。
...
-   **插件体系**：提供各种类别的插件，用户可以按需取用，快速实现 Vanguard-TestOps 测试能力的扩展以及与 DevOps 流水线的集成。
...
你也可以通过 [1Panel 应用商店](https://1panel.cn/) 快速部署 Vanguard-TestOps。
