...
import io.vanguard.testops.api.constants.ApiResourceType;
...
import io.vanguard.testops.api.dto.definition.ExecutePageRequest;
...
import io.vanguard.testops.api.dto.response.ApiScenarioBatchOperationResponse;
import io.vanguard.testops.api.dto.scenario.*;
import io.vanguard.testops.api.job.ApiScenarioScheduleJob;
import io.vanguard.testops.api.mapper.*;
import io.vanguard.testops.api.support.parser.step.StepParser;
import io.vanguard.testops.api.support.parser.step.factory.StepParserFactory;
...
import io.vanguard.testops.api.support.scenario.ApiDefinitionUtils;
import io.vanguard.testops.api.support.scenario.ApiScenarioBatchOperationUtils;
import io.vanguard.testops.api.support.scenario.ApiScenarioUtils;
import io.vanguard.testops.functional.domain.FunctionalCaseTestExample;
import io.vanguard.testops.functional.mapper.FunctionalCaseTestMapper;
...
import io.vanguard.testops.project.service.MoveNodeService;
...
import io.vanguard.testops.sdk.domain.EnvironmentGroupExample;
...
import io.vanguard.testops.sdk.file.MinioRepository;
...
import io.vanguard.testops.system.dto.request.ScheduleConfig;
...
import io.vanguard.testops.system.service.OperationHistoryService;
...
import io.vanguard.testops.system.runtime.schedule.support.ScheduleUtils;
...
import static io.vanguard.testops.api.controller.result.ApiResultCode.API_SCENARIO_CIRCULAR_REFERENCE;
import static io.vanguard.testops.api.controller.result.ApiResultCode.API_SCENARIO_EXIST;
...
public class ApiScenarioService extends MoveNodeService {
    ...
    private ApiScenarioBatchOperationResponse copyAndInsert(List<String> scenarioIds, AtomicLong nextScenarioPos, ApiScenarioBatchCopyMoveRequest request, String operator) {
        ...
        OssRepository minioRepository = CommonBeanFactory.getBean(OssRepository.class);
