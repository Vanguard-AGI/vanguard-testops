...
public class ApiScenarioReportService {
    ...
    public ApiScenarioReportDTO get(String id) {
        ...
        scenarioReportDTO.setEnvironmentName(resolveEnvironmentName(scenarioReport.getEnvironmentId()));
        scenarioReportDTO.setCreatUserName(resolveUserName(scenarioReport.getCreateUser()));
