...
import io.vanguard.testops.bug.domain.BugLocalAttachmentExample;
...
import io.vanguard.testops.bug.mapper.BugLocalAttachmentMapper;
...
import io.vanguard.testops.sdk.util.MsFileUtils;
...
import io.vanguard.testops.system.service.UserToolService;
...
public class BugAttachmentService {
    ...
    public void saveSyncAttachmentToMs(Platform platform, String bugId, String fileName, String fileKey, String projectId) {
        try {
            platform.getAttachmentContent(fileKey, (in) -> {
                ...
                byte[] bytes;
                try {
                    // upload platform attachment to OSS
    ...
    public void transferTmpFile(String bugId, String projectId, List<String> uploadFileIds, String userId, String source) {
        ...
        // 上传文件到对象存储
        LogUtils.info("upload to OSS start");
        ...
        LogUtils.info("upload to OSS end");
    }

    /**
     * 根据文件ID，查询OSS中对应目录下的文件名称
     */
