...
import io.vanguard.testops.system.dto.*;
import io.vanguard.testops.system.dto.request.*;
...
public class OrganizationService {
    ...
    public OrganizationDTO add(OrganizationDTO organizationDTO) {
        checkAddOrganization(organizationDTO);
        Organization organization = new Organization();
        BeanUtils.copyBean(organization, organizationDTO);
        organization.setId(IDGenerator.nextStr());
        organization.setNum(getNextNum());
        organization.setCreateTime(System.currentTimeMillis());
        organization.setUpdateTime(System.currentTimeMillis());
        organization.setCreateUser(organizationDTO.getCreateUser());
        organization.setUpdateUser(organizationDTO.getCreateUser());
    ...
    private void checkAddOrganization(OrganizationDTO organizationDTO) {
        OrganizationExample example = new OrganizationExample();
        example.createCriteria().andNameEqualTo(organizationDTO.getName()).andDeletedEqualTo(false);
    ...
    private long getNextNum() {
        Organization org = extOrganizationMapper.getMaxNumOrganization();
        return org == null ? 100001 : org.getNum() + 1;
    }
