# Vanguard-TestOps : Open-source Continuous Testing Platform
...
Only need two steps to install Vanguard-TestOps：

What you need:
1.  Prepare a 64-bit Linux host with no less than 8 G RAM
2.  Log into root user and execute the command down below to install Vanguard-TestOps
