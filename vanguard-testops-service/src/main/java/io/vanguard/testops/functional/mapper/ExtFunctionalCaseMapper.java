...
public interface ExtFunctionalCaseMapper {
    ...
    /**
     * 统计时间范围内新增的 AI 用例数（ai_create=true，deleted=false）
     * 查询条件：projectIds、create_user、create_time 时间范围
     */
    long countAiCaseInRange(@Param("projectIds") List<String> projectIds,
                           @Param("createUser") String createUser,
                           @Param("createTimeStart") Long createTimeStart,
                           @Param("createTimeEnd") Long createTimeEnd);

    /**
     * 统计时间范围内新增的手工用例数（ai_create=false，deleted=false）
     * 查询条件：projectIds、create_user、create_time 时间范围
     */
    long countManualCaseInRange(@Param("projectIds") List<String> projectIds,
                               @Param("createUser") String createUser,
                               @Param("createTimeStart") Long createTimeStart,
                               @Param("createTimeEnd") Long createTimeEnd);
