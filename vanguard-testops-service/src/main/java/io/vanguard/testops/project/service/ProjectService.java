...
import io.vanguard.testops.project.constants.ProjectMenuConstants;
...
import io.vanguard.testops.system.mapper.ExtSystemProjectMapper;
...
import io.vanguard.testops.system.service.CommonProjectPoolService;
...
public class ProjectService {
    ...
    public List<ProjectSimpleDTO> getPublicProjectList() {
        return baseProjectMapper.getProjectOptions().stream()
                .map(option -> {
